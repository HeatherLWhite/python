...
pmfPaths = [
    "/mnt/c/Users/heath/Ubuntu/SimulationResults/heather_sim/tensile/chain_length_variation/gd0-05_L20/sr0_000001/PMF.txt",
...
for count in range(0,numPlots):
    ...
    plt.plot(totalStrainList, pmfList, color=colorList[count])
...
for count in range(0,numPlots):
    ...
    plt.plot(totalStrainList, pmfNormPeakList, color=colorList[count])
...
for count in range(0,numPlots):
    ...
    plt.plot(totalStrainList, pmfNormVolList, color=colorList[count])
